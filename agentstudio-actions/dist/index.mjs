...
function RollbackCard({ data, onAction }) {
  ...
  const rollback = data;
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-orange-800 bg-orange-950/30 p-5 font-mono", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsx("span", { className: "text-orange-400 font-bold text-sm", children: "\u21A9 Rollback" }),
      /* @__PURE__ */ jsx("span", { className: "text-gray-400 text-xs", children: rollback.service })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 mb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-gray-900 rounded p-3", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mb-1", children: "Current (will revert)" }),
        /* @__PURE__ */ jsx("p", { className: "text-red-400 text-sm font-bold", children: rollback.currentVersion })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-gray-900 rounded p-3", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mb-1", children: "Target (stable)" }),
        /* @__PURE__ */ jsx("p", { className: "text-green-400 text-sm font-bold", children: rollback.targetVersion })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mb-2", children: "Changes being reverted" }),
      /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: (rollback.changes ?? []).map((c, i) => /* @__PURE__ */ jsxs("li", { className: "text-xs text-gray-400 flex gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "-" }),
        c
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-xs text-gray-500 mb-4", children: [
    ...
    !confirming ? /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    ] }) : /* @__PURE__ */ jsxs("div", { className: "bg-orange-900/50 border border-orange-700 rounded p-3", children: [
      /* @__PURE__ */ jsxs("p", { className: "text-xs text-orange-300 mb-3", children: [
        "\u26A0 This will rollback ",
        rollback.service,
...
function EscalateCard({ data, onAction }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: `rounded-lg border p-5 font-mono ${isP1 ? "border-red-800 bg-red-950/30" : "border-yellow-800 bg-yellow-950/30"}`, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsx2("span", { className: `font-bold text-sm ${isP1 ? "text-red-400" : "text-yellow-400"}`, children: "\u26A1 Escalate" }),
      /* @__PURE__ */ jsx2("span", { className: `px-2 py-0.5 rounded text-xs font-bold text-white ${isP1 ? "bg-red-500" : "bg-yellow-600"}`, children: incident.severity }),
      /* @__PURE__ */ jsx2("span", { className: "text-gray-500 text-xs", children: incident.incidentId })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "mb-4 bg-gray-900 rounded p-3", children: [
      /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-500 mb-1", children: "Business impact" }),
      /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-300", children: incident.businessImpact })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "grid grid-cols-2 gap-3 mb-4", children: [
      /* @__PURE__ */ jsxs2("div", { className: "bg-gray-900 rounded p-3", children: [
        /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-500 mb-1", children: "On-call engineer" }),
        /* @__PURE__ */ jsx2("p", { className: "text-sm text-blue-400", children: ((_a = incident.oncallEngineer) == null ? void 0 : _a.name) ?? "\u2014" }),
        /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-600", children: ((_b = incident.oncallEngineer) == null ? void 0 : _b.handle) ?? "\u2014" })
      ] }),
      /* @__PURE__ */ jsxs2("div", { className: "bg-gray-900 rounded p-3", children: [
        /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-500 mb-1", children: "Slack channel" }),
        /* @__PURE__ */ jsx2("p", { className: "text-sm text-green-400", children: incident.slackChannel })
      ] })
    ] }),
...
function MCPComposer({ data, onAction }) {
  ...
  const [steps] = useState2(suggestedWorkflow ?? []);
  return /* @__PURE__ */ jsxs3("div", { className: "rounded-lg border border-purple-800 bg-purple-950/20 p-5 font-mono", children: [
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsx3("span", { className: "text-purple-400 font-bold text-sm", children: "\u26A1 MCP Composer" }),
      /* @__PURE__ */ jsxs3("span", { className: "text-xs text-gray-500", children: [
        (availableTools == null ? void 0 : availableTools.length) ?? 0,
        " tools available"
      ] })
    ] }),
    /* @__PURE__ */ jsx3("div", { className: "flex gap-2 flex-wrap mb-4", children: (availableTools ?? []).map((t) => /* @__PURE__ */ jsx3(
      "span",
      {
    ...
    /* @__PURE__ */ jsxs3("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsx3("p", { className: "text-xs text-gray-500 mb-2", children: "Suggested workflow" }),
      /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: steps.map((step, i) => {
        var _a;
        return /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-3 bg-gray-900 rounded px-3 py-2", children: [
          /* @__PURE__ */ jsx3("span", { className: "text-xs text-gray-600 w-4", children: i + 1 }),
          /* @__PURE__ */ jsx3("span", { className: `text-xs font-medium w-20 ${((_a = toolColors[step.tool]) == null ? void 0 : _a.split(" ")[0]) ?? "text-gray-400"}`, children: step.tool }),
          /* @__PURE__ */ jsx3("span", { className: "text-xs text-gray-400", children: step.action })
        ] }, i);
      }) })
    ] }),
    /* @__PURE__ */ jsx3(
...
function WorkflowBuilder({ data, onAction }) {
  ...
  const [steps, setSteps] = useState3(initialSteps ?? []);
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "rounded-lg border border-blue-800 bg-blue-950/20 p-5 font-mono", children: [
    /* @__PURE__ */ jsx4("h3", { className: "text-sm font-semibold text-blue-300 mb-4", children: title }),
    /* @__PURE__ */ jsx4("div", { className: "space-y-2 mb-4", children: steps.map((step) => {
      const cfg = statusConfig[step.status];
      return /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-3 bg-gray-900 rounded px-3 py-2", children: [
        /* @__PURE__ */ jsx4(
          "span",
          {
        ...
        /* @__PURE__ */ jsx4("span", { className: "text-xs text-gray-300 flex-1", children: step.title }),
        /* @__PURE__ */ jsx4("span", { className: "text-xs text-gray-600", children: step.tool })
      ] }, step.id);
    }) }),
    !allDone ? /* @__PURE__ */ jsx4(
      "button",
      {
        onClick: runWorkflow,
        disabled: running,
    ...
    ) : /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-2 text-green-400 text-sm", children: [
      /* @__PURE__ */ jsx4("span", { children: "\u2713" }),
      /* @__PURE__ */ jsx4("span", { children: "All steps complete" })
    ] })
  ] });
}
