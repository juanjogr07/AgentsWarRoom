...
function EmptyState({ message }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rounded-lg border border-dashed border-gray-700 bg-gray-950 p-8 font-mono flex items-center justify-center ring-1 ring-white/5", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs text-gray-600", children: message }) });
}
function LoadingState({ rows = 3 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono space-y-3 ring-1 ring-white/5", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-3 bg-gray-800 rounded animate-pulse w-1/3 delay-0" }),
    Array.from({ length: rows }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
...
function IncidentDashboard({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `rounded-lg border ${colors.border} ${isResolved ? "bg-gray-950 opacity-75" : colors.bg} p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-3 mb-4 flex-wrap", children: [
      ...
      incident.status && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `px-2 py-0.5 rounded text-xs font-medium ${statusBadge[incident.status] ?? "bg-gray-800 text-gray-400"}`, children: incident.status }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `text-sm font-semibold ${colors.text} flex-1 min-w-0 truncate`, children: incident.title }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-gray-500 shrink-0", children: timeLabel(incident) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mb-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-gray-500 mb-1", children: "Affected services" }),
    ...
    incident.timeline && incident.timeline.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mb-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "space-y-1.5 border-l border-gray-800 pl-3", children: incident.timeline.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex gap-3 text-xs relative", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-1.5 h-1.5 rounded-full bg-gray-700 absolute -left-[1.05rem] top-1" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-gray-600 shrink-0", children: new Date(e.at).toLocaleTimeString() }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-gray-300 break-words min-w-0", children: e.event })
      ] }, i)) })
    ] }),
...
function UnhealthyBadge({ services }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-xs font-semibold", children: [
    down > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-red-400", children: [
      down,
      " down"
    ] }),
    down > 0 && degraded > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-gray-600", children: " \xB7 " }),
    degraded > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-yellow-400", children: [
      degraded,
      " degraded"
    ] })
  ] });
...
function ServiceHealth({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-3 min-w-0", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { className: "text-sm font-semibold text-gray-300 shrink-0", children: "Service Health" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UnhealthyBadge, { services: sorted })
      ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-2", children: sorted.map((s) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: `flex items-center gap-2 rounded px-3 py-2 border ${cfg.border} bg-gray-900`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: `w-2 h-2 rounded-full ${cfg.dot} shrink-0` }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-gray-300 w-28 shrink-0 truncate", children: s.name }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `text-xs ${cfg.text} w-14 shrink-0`, children: s.status }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-xs text-gray-500 w-24 shrink-0", children: [
          "p99:",
          s.latencyP99,
          "ms"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `text-xs w-16 text-right shrink-0 ${s.errorRate > 1 ? "text-red-400" : "text-gray-600"}`, children: [
          s.errorRate,
          "%"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-xs text-gray-700 w-14 text-right shrink-0", children: [
          s.rps,
          "rps"
        ] }),
        s.uptimePct != null && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `text-xs w-14 text-right shrink-0 ${s.uptimePct < 99 ? "text-yellow-500" : "text-gray-700"}`, children: [
          s.uptimePct,
          "%up"
        ] }),
...
function DaysLabel({ days }) {
  if (days <= 0) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs text-red-400 font-semibold", children: "OVERDUE" });
  if (days === 1) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs text-yellow-400", children: "1d left" });
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "text-xs text-gray-500", children: [
    days,
    "d left"
  ] });
}
function SprintBoard({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "text-sm font-semibold text-gray-300 truncate", children: sprintName }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex gap-4 text-xs shrink-0 ml-3", children: [
        blocked > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "text-red-400", children: [
          blocked,
          " blocked"
        ] }),
        done > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "text-green-400", children: [
          done,
          " done"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DaysLabel, { days: daysRemaining })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "space-y-2", children: tasks.map((t) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `rounded border ${cfg.border} ${cfg.bg} px-3 py-2`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2 min-w-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs text-gray-600 shrink-0", children: t.id }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs text-gray-200 flex-1 truncate", children: t.title }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: `text-xs ${cfg.text} shrink-0`, children: cfg.label }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs text-gray-600 shrink-0", children: t.assignee }),
        ...
        t.blocker && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "text-xs text-red-300 mt-1 ml-8 line-clamp-2", children: [
          "\u26A1 ",
          t.blocker
        ] })
      ] }, t.id);
...
function MetricsChart({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_recharts.ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_recharts.LineChart, { data: points, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_recharts.YAxis, { tick: { fontSize: 9, fill: "#6b7280" }, width: 36 }),
      ...
      threshold != null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_recharts.ReferenceLine, { y: threshold, stroke: "#f59e0b", strokeDasharray: "3 3", strokeOpacity: 0.7 }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
...
function DeployHistory({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-xs text-gray-500", children: elapsed(d.deployedAt) }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "ml-auto", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              "button",
              {
                ...
                children: isPending ? "Cancel" : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
                  "\u21A9 Rollback to ",
                  d.version
                ] })
              }
...
function AlertFeed({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-2", children: alerts.map((a) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `w-2 h-2 rounded-full ${cfg.dot} shrink-0 mt-1 ${isActiveCritical ? "animate-pulse" : ""}` }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-gray-300 mt-0.5 break-words", children: a.message })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-xs text-gray-600 shrink-0 mt-0.5", children: elapsed(a.firedAt) })
          ]
        },
        a.id
      );
...
function PersonRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-3 rounded px-3 py-2.5 border border-gray-800 bg-gray-900", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: `w-2 h-2 rounded-full ${dotColor} shrink-0` }),
...
function OnCallStatus({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono ring-1 ring-white/5${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center justify-between mb-4", children: [
      ...
      escalationPolicy && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-xs text-gray-500", children: escalationPolicy })
    ] }),
